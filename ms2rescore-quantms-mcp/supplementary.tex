...
\begin{table}[h!]
\centering
\caption{Experiment metadata and search tolerances (from SDRF). Columns: project accession, analytical method, instrument, fragmentation, tolerances (precursor/fragment), protease, modifications.}
\begin{tabular}{|c|c|c|c|c|c|>{\centering\arraybackslash}p{5.5cm}|}
\hline
Project & Method & Instrument & Fragmentation & Tolerances & Protease & Modifications \\
\hline
PXD001819 & LFQ & \shortstack[c]{LTQ O.\\Velos} & CID & \shortstack[c]{20 ppm\\0.5 Da} & Trypsin/P & \shortstack[c]{Carb (C)\\Ox (M)\\Ac} \\
\hline
PDC000127 & TMT & \shortstack[c]{O. Fusion\\Lumos} & HCD & \shortstack[c]{20 ppm\\20 ppm} & Trypsin & \shortstack[c]{Carb (C)\\TMT\\Ox (M)\\Ac} \\
\hline
PXD019643 & Immuno & \shortstack[c]{O. Fusion\\Lumos} & HCD & \shortstack[c]{5 ppm\\0.02 Da} & Unspecific & \shortstack[c]{Carb (C)\\Ox (M)} \\
\hline
PXD026824 & Phospho & \shortstack[c]{O. Fusion\\Lumos} & HCD & \shortstack[c]{20 ppm\\0.03 Da} & Trypsin & \shortstack[c]{Carb (C)\\Ox (M)\\Ac\\Phos} \\
\hline
\end{tabular}
\caption*{\footnotesize Acronyms: Carb = Carbamidomethyl; Ox = Oxidation; Ac = Acetyl; Phos = Phosphorylation; TMT = Tandem Mass Tag.}
\label{tab:experiment_metadata}
\end{table}
